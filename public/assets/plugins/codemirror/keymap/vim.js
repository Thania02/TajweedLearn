...
(function(mod) {
    ...
    var Vim = function() {
        ...
        var upperCaseChars;
        try { upperCaseChars = new RegExp("^[\\p{Lu}]$", "u"); } catch (_) { upperCaseChars = /^[A-Z]$/; }
        ...
        var vimApi = {
            ...
            findKey: function(cm, key, origin) {
                ...
                function handleKeyInsertMode() {
                    ...
                    if (match.type == 'none') { clearInputState(cm); return false; } else if (match.type == 'partial') {
                ...
                function handleKeyNonInsertMode() {
                    ...
                    if (match.type == 'none') { clearInputState(cm); return false; } else if (match.type == 'partial') { return true; }
                ...
                var command;
                if (vim.insertMode) { command = handleKeyInsertMode(); } else { command = handleKeyNonInsertMode(); }
                if (command === false) {
        ...
        function makeCmSelection(cm, sel, mode, exclusive) {
            ...
            if (mode == 'char') {
                ...
                var top = Math.min(anchor.line, head.line),
                    ...
                    toCh = head.ch;
                if (fromCh < toCh) { toCh += 1 } else { fromCh += 1 };
        ...
        var exCommands = {
            ...
            substitute: function(cm, params) {
                ...
                var regexPart, replacePart = '',
                    trailing, flagsPart, count;
