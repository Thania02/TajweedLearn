...
(function(global, factory) {
    ...
    ContentEditableInput.prototype.receivedFocus = function() {
        ...
        var input = this;
        if (this.selectionInEditor()) { setTimeout(function() { return this$1.pollSelection(); }, 20); } else { runInOp(this.cm, function() { return input.cm.curOp.selectionChanged = true; }); }
