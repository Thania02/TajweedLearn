var Filterizr = function(t) {
    ...
    var S, O = function(t, e, n, r) {
        ...
        Q = function(t) { return { padding: t.get().gutterPixels + "px" } },
        Z = function() {
            var t = function(e, n) {
                return (t = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(t, e) { t.__proto__ = e } || function(t, e) { for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]) })(e, n)
        ...
        $ = function(t) {
            ...
            return Z(e, t), e.prototype.initialize = function() {
                var t;
                this.set((t = this.options, B({}, Q(t), { position: "relative", width: "100%", display: "flex", flexWrap: "wrap" })))
            }, e.prototype.updatePaddings = function() { this.set(Q(this.options)) }, e.prototype.setHeight = function(t) { this.set({ height: t + "px" }) }, e
        }(A),
        J = function() {
            var t = function(e, n) {
                return (t = Object.setPrototypeOf || { __proto__: [] }
        ...
        V = function(t) {
            ...
            return J(e, t), Object.defineProperty(e.prototype, "styles", { get: function() { return this.styledNode }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, "filterizrState", { set: function(t) { this._filterizrState = t }, enumerable: !0, configurable: !0 }), e.prototype.destroy = function() { t.prototype.destroy.call(this), this.unbindEvents(), this.filterItems.destroy() }, e.prototype.makeFilterItems = function(t) {
    ...
    var ht = function(t, e, n, r) {
        ...
        yt = function() {
            function t(t, e) {
                ...
                this.windowEventReceiver = new y(window), this.filterContainer = new V(c(t), this.options), this.imagesHaveLoaded = !this.filterContainer.node.querySelectorAll("img").length, r && (this.filterControls = new w(this, i)), o && (this.spinner = new rt(this.filterContainer, this.options)), this.initialize()
            }
